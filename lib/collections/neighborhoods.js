...
Meteor.methods({
    insertNeighborhood: function(neighborhoodInfo){
        ...
        insertWelcomePost(neighborhoodId);
        return {
            _id: neighborhoodId
        };
    },
...
insertWelcomePost = function(neighborhoodId){
    var nb = Neighborhoods.findOne({_id: neighborhoodId});
    var post = {
        message: "Welcome to " + nb.properties.name,
        tags: 'welcome'
    };
